...
const Fun = () => {
  ...
  const logosList = [
    ...
    {
      name: "Mario Kart World: Playing a video game competitively pt. 3?",
      logoImage: "image-path",
      description: "Old franchise, new console, same obsession :D\nTop placement: 10th in the world and 2 Canadian records (2025)",
      image: mariokart3,
      icon: "Mario Kart World (Nintendo Switch 2)"
    },
    {
