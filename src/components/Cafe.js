...
export default function Scene({ ...props }) {
  ...
  return (
    <>
      <color attach="background" args={['#5e5f62']} />
      <group {...props} dispose={null}>
        <scene name="Scene 1">
          ...
          <OrthographicCamera name="1" makeDefault={true} position={[0, 65, 6]} rotation={[0, 0, 0]} far={10000} near={-50000} />
